...
router.post("/create", (req, res) => {
  const user = new userModel(req.body.id, req.body.email, req.body.password); //vi laver en user varibel, som indeholder vores user objekt, og herefter tilgår vi hhv. id, email og password ved at bruge req.body.xx
